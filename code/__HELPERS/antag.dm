...
<<<<<<< HEAD
				if(alert(O,"Do you want to become the [role_text]? Hurry up, you have 60 seconds to make choice!","Antag lottery","Yes","No") == "Yes")//Occulus Edit: removed particularily autistic text in popup
=======
