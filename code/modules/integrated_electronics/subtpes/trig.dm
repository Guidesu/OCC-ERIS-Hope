...
/obj/item/integrated_circuit/trig/tangent/do_work()
	...
	var/result = null
	var/A = get_pin_data(IC_INPUT, 1)
<<<<<<< HEAD:code/modules/integrated/integrated_electronics/subtypes/trig.dm
	if(isnum(A))
=======
	if(!isnull(A))
>>>>>>> d75ed0d4c1f195874792113784be98d2fafb211e:code/modules/integrated_electronics/subtpes/trig.dm
		result = TAN(A)
