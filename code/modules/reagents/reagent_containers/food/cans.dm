...
=======
	name = "Thirteen Loko"
	desc = "A strong energy drink with a real kick. Please drink responsibly."
>>>>>>> d75ed0d4c1f195874792113784be98d2fafb211e
...
/obj/item/reagent_containers/food/drinks/cans/waterbottle
	name = "bottled water"
	desc = "An unbranded bottle of simple, clean water."
	icon_state = "waterbottle"
	center_of_mass = list("x"=15, "y"=8)
	preloaded_reagents = list("water" = 30)
...
/obj/item/reagent_containers/food/drinks/cans/baton
	...
	center_of_mass = list("x"=16, "y"=6)
	preloaded_reagents = list("energy_drink_baton" = 25, "sodawater" = 25, "lemonade" = 10)
	volume = 60
...
/obj/item/reagent_containers/food/drinks/cans/baton_apple
	...
	center_of_mass = list("x"=16, "y"=6)
	preloaded_reagents = list("energy_drink_baton" = 25, "sodawater" = 25, "tonic" = 10)
	volume = 60
