...
=======
		var/newlogin = sanitize(input(usr,"Enter login", "Login", stored_login) as text|null, 100)
>>>>>>> d75ed0d4c1f195874792113784be98d2fafb211e
		if(newlogin)
...
/datum/nano_module/program/uplink/nano_ui_interact(mob/user, ui_key = "main", var/datum/nanoui/ui = null, var/force_open = NANOUI_FOCUS, var/datum/nano_topic_state/state = GLOB.default_state)
