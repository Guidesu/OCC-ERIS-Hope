/obj/item/tool/shovel
	...
	edge = TRUE
<<<<<<< HEAD
	tool_qualities = list(QUALITY_SHOVELING = 30, QUALITY_DIGGING = 30, QUALITY_EXCAVATION = 10)//Occulus Edit: Removing Hammering
	rarity_value = 9.6
...
<<<<<<< HEAD
	tool_qualities = list(QUALITY_SHOVELING = 25, QUALITY_DIGGING = 25, QUALITY_EXCAVATION = 10)//Occulus Edit: Removing Hammering
	degradation = 1.5
...
<<<<<<< HEAD
	tool_qualities = list(QUALITY_SHOVELING = 20, QUALITY_DIGGING = 20, QUALITY_EXCAVATION = 10)//Occulus Edit: Removing Hammering
	max_upgrades = 2
	rarity_value = 19.2
=======
...
<<<<<<< HEAD
	tool_qualities = list(QUALITY_SHOVELING = 60, QUALITY_DIGGING = 40, QUALITY_EXCAVATION = 20)//Occulus Edit: Removing Hammering
=======
